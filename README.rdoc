...
Modify config/locales/en.yml. Replace references to Mwahmed.

Modify config/application.rb. Replace references to Mwahmed.
...
Mwahmed is pre-configured to make it easy to deploy apps into production environments.
...
* setup Errbit or Airbrake and configure Mwahmed to track errors
